//! Round-trip and id-stability goldens (`cumulus/docs/SPEC.md` §10).
//!
...
fn operation_and_view_id_goldens() {
    assert_eq!(
        ids::view_id(&golden_view()).hex(),
        "3294a051f0a65b80528a6294eadeb04e247ece3444e09a11f20d8ffc35211565dcb20e2682ee77327f47a69dd59c8dcaf95cb5ec8985093ba10a91b73d230969"
    );
    assert_eq!(
        ids::operation_id(&golden_operation()).hex(),
        "a41c87175f6e081b67898097a04d1366213315a287dfdc52f0e5cb3eb0ca71dffed85abc605baba45c326d8703566e19fdccc696540a60d5613b7c288c5915ae"
    );
}
...
fn commit_proto_encoding_golden() {
    ...
    assert_eq!(
        hex,
        ""
    );
}
